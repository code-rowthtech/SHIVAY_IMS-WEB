...
const OpeningStock = () => {
    ...
    return (
        <div>
            ...
            <AddStockModal show={showAddModal} onHide={() => setShowAddModal(false)} />

            <EditStockModal show={showEditModal} onHide={() => setShowEditModal(false)} stockId={editData} />
        </div>
    );
};
