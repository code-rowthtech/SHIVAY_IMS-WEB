...
import { MdOutlineSell, MdOutlineStoreMallDirectory } from 'react-icons/md';
...
const Dashboard = () => {
    ...
    const dashboardLoading = store?.dashboardDataReducer?.loading; // Add this to get loading state
        ...
        <>
            ...
            <Row className="g-4 mt-2">
                {Role === 'admin' ? (
                                  ...
                                  Array(4)
                                      ...
                                      .map((_, index) => (
                                          <Col key={index} md={6} lg={3} className="pt-3">
                                              <Card className="border-0 dashboard-card mt-0">
                                                  <Card.Body className="d-flex align-items-center justify-content-between dashboard-card-body">
                                                      <div>
                                                          <Skeleton
                                                              height={20}
                                                              width={100}
                                ...
                                : dashboardItems?.map((item, index) => (
                                      <Col key={index} md={6} lg={3} className="pt-3">
                                          <Link to={item.link} className="text-decoration-none">
                                              <Card
                                                  className="border-0 text-white dashboard-card dashboard-card-hover mt-0"
                                                  style={
                    ...
                    <div className="m-0">
                        <Row className="d-flex align-items-center">
                            {dashboardLoading
                                ? // Render skeleton cards for non-admin users
                                  Array(4)
                                      .fill()
                                      .map((_, index) => (
                                          <Col key={index} md={6} lg={3} className="pt-3">
                                              <Card className="border-0 mt-0 dashboard-card">
                                                  <Card.Body className="d-flex align-items-center justify-content-between dashboard-card-body">
                                                      <div>
                ...
                {/* Rest of your code (List section, tables, etc.) remains unchanged */}
                <div className="mt-0">
                                                        ...
                                                        StockinData?.map((data, index) => (
                                                            <tr
                                                                ...
                                                                <td
                                                                    ...
                                                                    {data?.supplierName ? (
                                                                        `${data.supplierName.slice(0, 25)}${
                                                                            data.supplierName.length > 25 ? '...' : ''
                                                                        }`
                                                                    ) : (
                                                                        <span className="text-black">-</span>
                                                                    )}
                                                                ...
                                                                <td>
                                                                    <span
                                                                        ...
                                                                        onClick={() =>
                                                                            navigate(
                                                                                `/shivay/ViewProduct?id=${data?.productId}&warehouseId=${data?.warehouseId}`
                                                                            )
                                                                        }>
                                                                        <PiEye
                                                                            className="fs-4"
                                                        ...
                                                        {DispatchData?.length === 0 ? (
                                                            ...
                                                            DispatchData?.map((data, index) => (
                                                                <tr
                                                                    ...
                                                                    className="text-dark text-nowrap highlight-row">
                                                                    <td className="font_work">
                                                                        {(dispatchPageIndex - 1) * dispatchPageSize +
                                                                            index +
                                                                            1}
                                                                    </td>
                                                                    <td className="font_work">
            ...
            <Offcanvas show={show} onHide={handleClose} placement="end" style={{ width: '60rem' }}>
                <Offcanvas.Header className="pb-0" closeButton>
                    <Offcanvas.Title>
                        <TiArrowLeft className="fw-bold fs-3" style={{ cursor: 'pointer' }} onClick={handleClose} />{' '}
                        Filter
                    </Offcanvas.Title>
                </Offcanvas.Header>
