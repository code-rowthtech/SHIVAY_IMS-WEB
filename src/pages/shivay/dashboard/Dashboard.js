    ...
    <>
                          ...
                          {StockinData?.length === 0 ? (
                            ...
                            StockinData?.map((data, index) => (
                              <tr key={index} className="text-dark text-nowrap highlight-row">
                                ...
                                <td className="text-capitalize font_work" title={data?.supplierName}>
                                  {data?.supplierName
                                ...
                                <td>
                                  ...
                                  >
                                    <PiEye className="fs-4" style={{ cursor: 'pointer' }} />
                                  </span>
                                </td>
                              </tr>
                            ))
                            ...
                            {DispatchData?.length === 0 ? (
                              ...
                              DispatchData?.map((data, index) => (
                                <tr key={index} className="text-dark text-nowrap highlight-row">
                                  ...
                                  <td className="font_work">
                                    {data?.stock !== null && data?.stock !== undefined && data.stock !== '' ? data.stock : <span className="text-black">-</span>}
                                  </td>
                                  <td className="font_work">
                                    {data?.date ? new Date(data.date).toLocaleDateString('en-GB') : <span className="text-black">-</span>}
                                  </td>
      ...
      <Offcanvas show={show} onHide={handleClose} placement="end" style={{ width: '60rem' }}>
        <Offcanvas.Header className="pb-0" closeButton>
          <Offcanvas.Title>
            <TiArrowLeft className="fw-bold fs-3" style={{ cursor: 'pointer' }} onClick={handleClose} /> Filter
          </Offcanvas.Title>
        </Offcanvas.Header>
