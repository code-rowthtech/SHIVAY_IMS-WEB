...
const Customer = () => {
    ...
    return (
        <div>
                    ...
                    <Col sm={12}>
                        <div className="d-flex justify-content-end mt-1">
                            ...
                            <Button
                                ...
                                onClick={() => handleCustomerModal(null, 'Add', true)}>
                            ...
                            <Card.Body className=" py-1">
                                                ...
                                                {CustomerData?.length === 0 ? (
                                                    ...
                                                    CustomerData?.map((data, index) => (
                                                        <tr
                                                            ...
                                                            <td
                                                                className="text-capitalize font_work"
                                                                title={data?.billingAddress}>
                                                                {data?.billingAddress ? (
                                                                    `${data.billingAddress.slice(0, 30)}${
                                                                        data.billingAddress.length > 30 ? '...' : ''
                                                                    }`
                                                                ) : (
                                                                    <span className="text-black">-</span>
                                                                )}
                                                            ...
                                                            <td>
                                                                <span
                                                                    ...
                                                                    title="Edit"
                                                                    onClick={() =>
                                                                        handleCustomerModal(data, 'Edit', true)
                                                                    }>
                                                                    <AiOutlineEdit
                                                                        className="fs-4"
                                ...
                                <Pagination
                                    ...
                                    totalPages={useSelector(
                                        (state) => state?.customerListReducer?.customerList?.totalPages
                                    )}
            ...
            <AddCustomerModal
                showModal={showCustomerModal?.status}
                handleClose={handleClose}
                CustomerData={showCustomerModal}
            />
