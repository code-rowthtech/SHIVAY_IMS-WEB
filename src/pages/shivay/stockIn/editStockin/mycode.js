...
function EditStockin() {
    ...
    const resetFormFields = () => {
        ...
        setAttachmentType('');
        // setToday(''); // if you want to clear the date
    };
            ...
            <Form onSubmit={handleSubmit(onSubmit)} className="  rounded-3  ">
                ...
                <Row>
                    ...
                    <Col sm={3}>
                        ...
                        {/* <Button className="custom-button" type="submit" disabled={store?.updateStockInReducer?.loading}>
                        ...
                        <Button
                            ...
                            type="submit"
                            onClick={() => {
                                // Optional: If form is manually handled
                                resetFormFields();
                            }}
