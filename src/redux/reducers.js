...
import { createProductReducer, deleteProductReducer, productListReducer, searchProductNameReducer, searchProductReducer, updateProductReducer, viewProductReducer, viewProductStockReducer } from './inventory/reducers';
...
export default (combineReducers({
  ...
  // inventory 
  productListReducer, createProductReducer, updateProductReducer, deleteProductReducer, searchProductReducer, viewProductReducer, searchProductNameReducer, viewProductStockReducer,
  // location
  locationReducer,
  // users 
